...
function display(){
    ...
    document.querySelector(".list").innerHTML += "<center><div class='element'>" + elements[i] + "<img class= 'tick' src='https://img.icons8.com/windows/2x/checkmark.png' onclick ='strike("+ i +")'><img class= 'dustbin' src = 'https://img.icons8.com/ios-filled/2x/trash.png' onclick='del("+ i + ")'></div></center>"
}
